...
#define PL_COND_FLAG_GRIPPER_CW        bit(4)
#define PL_COND_FLAG_GRIPPER_CCW       bit(5)
#define PL_COND_FLAG_COOLANT_FLOOD     bit(6)
#define PL_COND_FLAG_COOLANT_MIST      bit(7)
#define PL_COND_MOTION_MASK    (PL_COND_FLAG_RAPID_MOTION|PL_COND_FLAG_SYSTEM_MOTION|PL_COND_FLAG_NO_FEED_OVERRIDE)
#define PL_COND_GRIPPER_MASK   (PL_COND_FLAG_GRIPPER_CW|PL_COND_FLAG_GRIPPER_CCW)
#define PL_COND_ACCESSORY_MASK (PL_COND_FLAG_GRIPPER_CW|PL_COND_FLAG_GRIPPER_CCW|PL_COND_FLAG_COOLANT_FLOOD|PL_COND_FLAG_COOLANT_MIST)
...
typedef struct {
  ...
  float programmed_rate;        // Programmed rate of this block (mm/min).
    ...
    // Stored gripper speed data used by gripper overrides and resuming methods.
    float gripper_speed;    // Block gripper speed. Copied from pl_line_data.
  #endif
} plan_block_t;
...
typedef struct {
  ...
  float gripper_speed;      // Desired gripper speed through line motion.
